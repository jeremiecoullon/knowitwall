var switching_audioplayers = function(){
  ...
  var div_audioplayer = document.getElementById("switching_audioplayers");
  ...
  var cir_player2 = '" type="audio/mpeg" codecs="mp3"></source></audio><img id="circular_image" src="';
  ...
  if (width < 768)
    {
      div_audioplayer.innerHTML = cir_player;
      js.src = "/static/js/circular_player.js";
    }
    else{
      div_audioplayer.innerHTML = bar_player;
